! function(a) {
    ...
    var g = {
            ...
            return h(a, [{
                ...
                value: function(a) {
                    ...
                    if (b) {
                        ...
                        for (var f = b, g = Array.isArray(f), h = 0, f = g ? f : f[Symbol.iterator]();;) {
                            var i;
                            if (g) {
                                if (h >= f.length) break;
                                i = f[h++]
        ...
        j = function(a) {
            function g(a, c) {
                ...
                g.instances.push(e), e.element.dropzone = e;
                var i = null != (h = g.optionsForElement(e.element)) ? h : {};
                if (e.options = g.extend({}, e.defaultOptions, i, null != c ? c : {}), e.options.forceFallback || !g.isBrowserSupported()) {
                    var j;
                    return j = e.options.fallback.call(e), b(e, j)
                }
                ...
                return e.options.acceptedMimeTypes && (e.options.acceptedFiles = e.options.acceptedMimeTypes, delete e.options.acceptedMimeTypes), null != e.options.renameFilename && (e.options.renameFile = function(a) {
                    return e.options.renameFilename.call(e, a.name, a)
                }), e.options.method = e.options.method.toUpperCase(), (f = e.getExistingFallback()) && f.parentNode && f.parentNode.removeChild(f), !1 !== e.options.previewsContainer && (e.options.previewsContainer ? e.previewsContainer = g.getElement(e.options.previewsContainer, "previewsContainer") : e.previewsContainer = e.element), e.options.clickable && (!0 === e.options.clickable ? e.clickableElements = [e.element] : e.clickableElements = g.getElements(e.options.clickable, "clickable")), e.init(), e
            }
            return c(g, a), h(g, null, [{
                key: "initClass",
                value: function() {
                    this.prototype.Emitter = i, this.prototype.events = ["drop", "dragstart", "dragend", "dragenter", "dragover", "dragleave", "addedfile", "addedfiles", "removedfile", "thumbnail", "error", "errormultiple", "processing", "processingmultiple", "uploadprogress", "totaluploadprogress", "sending", "sendingmultiple", "success", "successmultiple", "canceled", "canceledmultiple", "complete", "completemultiple", "reset", "maxfilesexceeded", "maxfilesreached", "queuecomplete"], this.prototype.defaultOptions = {
                        ...
                        fallback: function() {
                            ...
                            return h && (null != h.textContent ? h.textContent = this.options.dictFallbackMessage : null != h.innerText && (h.innerText = this.options.dictFallbackMessage)), this.element.appendChild(this.getFallbackForm())
                        },
                        ...
                        addedfile: function(a) {
                            ...
                            if (this.element === this.previewsContainer && this.element.classList.add("dz-started"), this.previewsContainer) {
                                a.previewElement = g.createElement(this.options.previewTemplate.trim()), a.previewTemplate = a.previewElement, this.previewsContainer.appendChild(a.previewElement);
                                ...
                                for (var l = function(c) {
                                        return c.preventDefault(), c.stopPropagation(), a.status === g.UPLOADING ? g.confirm(b.options.dictCancelUploadConfirmation, function() {
                                            return b.removeFile(a)
                                        }) : b.options.dictRemoveFileConfirmation ? g.confirm(b.options.dictRemoveFileConfirmation, function() {
                                            return b.removeFile(a)
                                        }) : b.removeFile(a)
                        ...
                        uploadprogress: function(a, b, c) {
                            if (a.previewElement)
                                for (var d = a.previewElement.querySelectorAll("[data-dz-uploadprogress]"), e = Array.isArray(d), f = 0, d = e ? d : d[Symbol.iterator]();;) {
                                    var g;
                                    if (e) {
                                        if (f >= d.length) break;
                                        g = d[f++]
                ...
                value: function(a) {
                    ...
                    for (var e = c, f = Array.isArray(e), g = 0, e = f ? e : e[Symbol.iterator]();;) {
                        var h;
                        if (f) {
                            if (g >= e.length) break;
                            h = e[g++]
                ...
                value: function() {
                    ...
                    if ("form" === this.element.tagName && this.element.setAttribute("enctype", "multipart/form-data"), this.element.classList.contains("dropzone") && !this.element.querySelector(".dz-message") && this.element.appendChild(g.createElement('<div class="dz-default dz-message"><span>' + this.options.dictDefaultMessage + "</span></div>")), this.clickableElements.length) {
                        ! function b() {
                            return a.hiddenFileInput && a.hiddenFileInput.parentNode.removeChild(a.hiddenFileInput), a.hiddenFileInput = document.createElement("input"), a.hiddenFileInput.setAttribute("type", "file"), (null === a.options.maxFiles || a.options.maxFiles > 1) && a.hiddenFileInput.setAttribute("multiple", "multiple"), a.hiddenFileInput.className = "dz-hidden-input", null !== a.options.acceptedFiles && a.hiddenFileInput.setAttribute("accept", a.options.acceptedFiles), null !== a.options.capture && a.hiddenFileInput.setAttribute("capture", a.options.capture), a.hiddenFileInput.style.visibility = "hidden", a.hiddenFileInput.style.position = "absolute", a.hiddenFileInput.style.top = "0", a.hiddenFileInput.style.left = "0", a.hiddenFileInput.style.height = "0", a.hiddenFileInput.style.width = "0", document.querySelector(a.options.hiddenInputContainer).appendChild(a.hiddenFileInput), a.hiddenFileInput.addEventListener("change", function() {
                                ...
                                if (c.length)
                                    for (var d = c, e = Array.isArray(d), f = 0, d = e ? d : d[Symbol.iterator]();;) {
                                        var g;
                                        if (e) {
                                            if (f >= d.length) break;
                                            g = d[f++]
                    ...
                    for (var b = this.events, c = Array.isArray(b), d = 0, b = c ? b : b[Symbol.iterator]();;) {
                        var e;
                        if (c) {
                            if (d >= b.length) break;
                            e = b[d++]
                    ...
                    return this.listeners = [{
                        ...
                        events: {
                            ...
                            dragover: function(b) {
                                ...
                                return b.dataTransfer.dropEffect = "move" === c || "linkMove" === c ? "move" : "copy", h(b), a.emit("dragover", b)
                            },
                        ...
                        return a.listeners.push({
                            ...
                            events: {
                                click: function(c) {
                                    return (b !== a.element || c.target === a.element || g.elementInside(c.target, a.element.querySelector(".dz-message"))) && a.hiddenFileInput.click(), !0
                                }
                            }
                        })
                ...
                key: "destroy",
                value: function() {
                    return this.disable(), this.removeAllFiles(!0), (null != this.hiddenFileInput ? this.hiddenFileInput.parentNode : void 0) && (this.hiddenFileInput.parentNode.removeChild(this.hiddenFileInput), this.hiddenFileInput = null), delete this.element.dropzone, g.instances.splice(g.instances.indexOf(this), 1)
                }
            }, {
                ...
                value: function() {
                    ...
                    if (this.getActiveFiles().length) {
                        for (var d = this.getActiveFiles(), e = Array.isArray(d), f = 0, d = e ? d : d[Symbol.iterator]();;) {
                            ...
                            var h = g;
                            b += h.upload.bytesSent, c += h.upload.total
                        }
                        a = 100 * b / c
                    } else a = 100;
                ...
                value: function() {
                    ...
                    this.options.dictFallbackText && (c += "<p>" + this.options.dictFallbackText + "</p>"), c += '<input type="file" name="' + this._getParamName(0) + '" ' + (this.options.uploadMultiple ? 'multiple="multiple"' : void 0) + ' /><input type="submit" value="Upload!"></div>';
                    var d = g.createElement(c);
                    return "FORM" !== this.element.tagName ? (b = g.createElement('<form action="' + this.options.url + '" enctype="multipart/form-data" method="' + this.options.method + '"></form>'), b.appendChild(d)) : (this.element.setAttribute("enctype", "multipart/form-data"), this.element.setAttribute("method", this.options.method)), null != b ? b : d
                }
            }, {
                ...
                key: "paste",
                value: function(a) {
                    if (null != e(null != a ? a.clipboardData : void 0, function(a) {
                            return a.items
                        })) {
                        this.emit("paste", a);
                ...
                value: function(a, b) {
                    var c = this,
                        d = a.createReader(),
                        e = function(a) {
                            return f(console, "log", function(b) {
                                return b.log(a)
                            })
                        };
                    return function a() {
                        return d.readEntries(function(d) {
                            if (d.length > 0) {
                                for (var e = d, f = Array.isArray(e), g = 0, e = f ? e : e[Symbol.iterator]();;) {
                                    var h;
                                    if (f) {
                                        if (g >= e.length) break;
                                        h = e[g++]
                ...
                value: function(a) {
                    ...
                    }, this.files.push(a), a.status = g.ADDED, this.emit("addedfile", a), this._enqueueThumbnail(a), this.accept(a, function(c) {
                ...
                value: function(a) {
                    ...
                    for (var b = this.files.slice(), c = Array.isArray(b), d = 0, b = c ? b : b[Symbol.iterator]();;) {
                        ...
                        var f = e;
                        (f.status !== g.UPLOADING || a) && this.removeFile(f)
                    }
                    return null
                }
            }, {
                ...
                value: function(a, b, c, d, e) {
                    var f = this;
                    return this.createThumbnail(a, b, c, d, !1, function(b, c) {
                        if (null == c) return e(a);
                        var d = f.options.resizeMimeType;
                        null == d && (d = a.type);
                        var h = c.toDataURL(d, f.options.resizeQuality);
                        return "image/jpeg" !== d && "image/jpg" !== d || (h = o.restore(a.dataURL, h)), e(g.dataURItoBlob(h))
                    })
                }
            }, {
                key: "createThumbnail",
                ...
                value: function(a) {
                    for (var b = a, c = Array.isArray(b), d = 0, b = c ? b : b[Symbol.iterator]();;) {
                        ...
                        var f = e;
                        f.processing = !0, f.status = g.UPLOADING, this.emit("processing", f)
                    }
                ...
                value: function(a) {
                    if (a.status === g.UPLOADING) {
                        ...
                        for (var h = b, i = Array.isArray(h), j = 0, h = i ? h : h[Symbol.iterator]();;) {
                            var k;
                            if (i) {
                                if (j >= h.length) break;
                                k = h[j++]
                ...
                value: function(a) {
                    var b = this;
                    this._transformFiles(a, function(c) {
                        if (a[0].upload.chunked) {
                            ...
                            if (d.upload.finishedChunkUpload = function(c) {
                                    var e = !0;
                                    c.status = g.SUCCESS, c.dataBlock = null;
                                    for (var f = 0; f < d.upload.totalChunkCount; f++) {
                                        if (void 0 === d.upload.chunks[f]) return h();
                                        d.upload.chunks[f].status !== g.SUCCESS && (e = !1)
                                    }
                                    e && b.options.chunksUploaded(d, function() {
                                        b._finished(a, "", null)
                                    })
                                }, b.options.parallelChunkUploads)
                                for (var i = 0; i < d.upload.totalChunkCount; i++) h();
                            else h()
                        } else {
                ...
                key: "_uploadData",
                value: function(a, b) {
                    for (var c = this, d = new XMLHttpRequest, e = a, f = Array.isArray(e), h = 0, e = f ? e : e[Symbol.iterator]();;) {
                        var i;
                        if (f) {
                            if (h >= e.length) break;
                            i = e[h++]
                    ...
                    d.open(j, k, !0), d.timeout = this.resolveOption(this.options.timeout, a), d.withCredentials = !!this.options.withCredentials, d.onload = function(b) {
                    ...
                    for (var s = a, t = Array.isArray(s), u = 0, s = t ? s : s[Symbol.iterator]();;) {
                        var v;
                        if (t) {
                            if (u >= s.length) break;
                            v = s[u++]
                    ...
                    this.options.uploadMultiple && this.emit("sendingmultiple", a, d, o), this._addFormElementData(o);
                ...
                value: function(a) {
                    if ("FORM" === this.element.tagName)
                        for (var b = this.element.querySelectorAll("input, textarea, select, button"), c = Array.isArray(b), d = 0, b = c ? b : b[Symbol.iterator]();;) {
                            var e;
                            if (c) {
                                if (d >= b.length) break;
                                e = b[d++]
                            ...
                            if (h && (h = h.toLowerCase()), void 0 !== g && null !== g)
                                if ("SELECT" === f.tagName && f.hasAttribute("multiple"))
                                    for (var i = f.options, j = Array.isArray(i), k = 0, i = j ? i : i[Symbol.iterator]();;) {
                                        var l;
                                        if (j) {
                                            if (k >= i.length) break;
                                            l = i[k++]
                ...
                value: function(a, b, c) {
                    ...
                    if (void 0 !== c) {
                        if (d = 100 * c.loaded / c.total, a[0].upload.chunked) {
                            ...
                            for (var h = a, i = Array.isArray(h), j = 0, h = i ? h : h[Symbol.iterator]();;) {
                                var k;
                                if (i) {
                                    if (j >= h.length) break;
                                    k = h[j++]
                                ...
                                var l = k;
                                l.upload.progress = d, l.upload.total = c.total, l.upload.bytesSent = c.loaded
                            }
                        for (var m = a, n = Array.isArray(m), o = 0, m = n ? m : m[Symbol.iterator]();;) {
                            var p;
                            if (n) {
                                if (o >= m.length) break;
                                p = m[o++]
                        ...
                        for (var s = a, t = Array.isArray(s), u = 0, s = t ? s : s[Symbol.iterator]();;) {
                            ...
                            var w = v;
                            100 === w.upload.progress && w.upload.bytesSent === w.upload.total || (r = !1), w.upload.progress = d, w.upload.bytesSent = w.upload.total
                        }
                        if (r) return;
                        for (var x = a, y = Array.isArray(x), z = 0, x = y ? x : x[Symbol.iterator]();;) {
                            var A;
                            if (y) {
                                if (z >= x.length) break;
                                A = x[z++]
                ...
                value: function(a, b, c) {
                    ...
                    if (a[0].status !== g.CANCELED && 4 === b.readyState) {
                        if ("arraybuffer" !== b.responseType && "blob" !== b.responseType && (d = b.responseText, b.getResponseHeader("content-type") && ~b.getResponseHeader("content-type").indexOf("application/json"))) try {
                            ...
                            c = a, d = "Invalid JSON response from server."
                        }
                        this._updateFilesUploadProgress(a), 200 <= b.status && b.status < 300 ? a[0].upload.chunked ? a[0].upload.finishedChunkUpload(this._getChunk(a[0], b)) : this._finished(a, d, c) : this._handleUploadError(a, b, d)
                    }
                }
            }, {
                ...
                value: function(a, b, c) {
                    if (a[0].status !== g.CANCELED) {
                        ...
                        for (var e = a, f = Array.isArray(e), h = 0, e = f ? e : e[Symbol.iterator]();;) {
                            if (f) {
                                if (h >= e.length) break;
                                e[h++]
                            } else {
                ...
                key: "_finished",
                value: function(a, b, c) {
                    for (var d = a, e = Array.isArray(d), f = 0, d = e ? d : d[Symbol.iterator]();;) {
                        var h;
                        if (e) {
                            if (f >= d.length) break;
                            h = d[f++]
                        ...
                        var i = h;
                        i.status = g.SUCCESS, this.emit("success", i, b, c), this.emit("complete", i)
                    }
                ...
                value: function(a, b, c) {
                    for (var d = a, e = Array.isArray(d), f = 0, d = e ? d : d[Symbol.iterator]();;) {
                        ...
                        var i = h;
                        i.status = g.ERROR, this.emit("error", i, b, c), this.emit("complete", i)
                    }
    ...
    j.initClass(), j.version = "5.4.0", j.options = {}, j.optionsForElement = function(a) {
        return a.getAttribute("id") ? j.options[l(a.getAttribute("id"))] : void 0
    }, j.instances = [], j.forElement = function(a) {
        ...
        return function() {
            for (var b = [], c = a, d = Array.isArray(c), e = 0, c = d ? c : c[Symbol.iterator]();;) {
                ...
                var g = f;
                !1 !== j.optionsForElement(g) ? b.push(new j(g)) : b.push(void 0)
            }
            return b
        }()
    }, j.blacklistedBrowsers = [/opera.*(Macintosh|Windows Phone).*version\/12/i], j.isBrowserSupported = function() {
        var a = !0;
        if (window.File && window.FileReader && window.FileList && window.Blob && window.FormData && document.querySelector)
            if ("classList" in document.createElement("a"))
                for (var b = j.blacklistedBrowsers, c = Array.isArray(b), d = 0, b = c ? b : b[Symbol.iterator]();;) {
                    var e;
                    if (c) {
                        if (d >= b.length) break;
                        e = b[d++]
    ...
    j.createElement = function(a) {
        ...
        if (a instanceof Array) {
            d = [];
            try {
                for (var e = a, f = Array.isArray(e), g = 0, e = f ? e : e[Symbol.iterator]();;) {
                    if (f) {
                        if (g >= e.length) break;
                        c = e[g++]
                    } else {
        ...
        if (!b) return !0;
        b = b.split(",");
        for (var c = a.type, d = c.replace(/\/.*$/, ""), e = b, f = Array.isArray(e), g = 0, e = f ? e : e[Symbol.iterator]();;) {
            var h;
            if (f) {
                if (g >= e.length) break;
                h = e[g++]
    ...
    }), void 0 !== g && null !== g ? g.exports = j : window.Dropzone = j, j.ADDED = "added", j.QUEUED = "queued", j.ACCEPTED = j.QUEUED, j.UPLOADING = "uploading", j.PROCESSING = j.UPLOADING, j.CANCELED = "canceled", j.ERROR = "error", j.SUCCESS = "success";
    var m = function(a) {
    ...
    return j._autoDiscoverFunction = function() {
        ...
        }(window, j._autoDiscoverFunction), g.exports
});