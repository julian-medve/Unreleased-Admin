                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('admin.administrator.index') }}">Administrator</a></li>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <form method="POST" action="{{ route('admin.administrator.update') }}" enctype="multipart/form-data">
