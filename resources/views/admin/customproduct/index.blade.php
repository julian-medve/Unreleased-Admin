                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#!">Custom 3D Product</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Custom 3D Models</h5>
                                        <div class="card-header-right">
                                        <a href="{{ route('admin.customproduct.add')}}"><button type="button" class="btn btn-primary">Add Custom 3D Model</button></a>
                                        </div>
                                    </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <a class="dropdown-item" href="{{ route('admin.customproduct.edit',  ['CustomProduct' => $item->Id]) }}"><i class="feather icon-edit"></i> &nbsp;&nbsp;Edit</a>
                                                                <a class="dropdown-item" href="{{ route('admin.customproduct.delete', ['CustomProduct' => $item->Id]) }}"><i class="feather icon-trash-2"></i>&nbsp;&nbsp;Delete</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    @endforeach
